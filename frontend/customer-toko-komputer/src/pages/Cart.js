...
export default class Cart extends React.Component{
    ...
    //headr berupa bearer token sebagai request API
    headerConfig = () => {
        let header = {
    ...
    //fungsi init cart ambil data dari localstorage dan enghitung total harga
    initCart = () => {
        //memmanggil data cart pada localstorage
        let tempCart = []
        ...
        //kalukulasi total harga
        let totalHarga = 0;
        tempCart.map(item => {
            totalHarga += (item.price * item.qty)
        })

        //memasukan data cart, user, dan total harga pada state
        this.setState({
            cart: tempCart,
            total: totalHarga
        })
